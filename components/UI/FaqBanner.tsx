...
const FaqBanner = ({ pageData }: Props) => {
  const [data] = useLiveQuery(pageData, faqPageQuery);

  return (
          <div
            className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12 md:my-24 mx-12"
          >
            <div className="flex flex-col items-center justify-center mx-14">
              <h2 className="text-xl md:text-3xl lg:text-5xl font-bold border-b-8 border-black m-8">
